...
const DMStandards = () => {
    const leftCriteria = [
        "Active search intent verification.",
        "Business qualification and funding eligibility.",
        "Contact information accuracy check.",
                ...
                <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-10 gap-6">
                    <div className="max-w-4xl text-left">
                        ...
                        <p className="text-fluid-sm text-slate-600 leading-relaxed mt-3">
                            We maintain rigorous quality control processes to ensure every digital marketing lead we deliver is verified, fresh, and ready for your sales outreach.
                        </p>
                    </div>
                    ...
                    <div className="lg:col-span-2 bg-white p-8 lg:p-10 rounded-[2.5rem] border border-slate-100/80 shadow-xs flex flex-col justify-between text-left">
                        <div>
                            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100">
                                ...
                                <h3 className="text-xl font-extrabold text-slate-900">Verification Criteria</h3>
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
                                {leftCriteria.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-fluid-sm font-semibold text-slate-700 leading-snug">{item}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                                ...
                                <ul className="space-y-3.5 mb-6">
                                    {pricingDetails.map((detail, index) => (
                                        <li key={index} className="flex items-center gap-3">
                                            ...
                                            <span className="text-fluid-sm font-medium text-slate-100">{detail}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
