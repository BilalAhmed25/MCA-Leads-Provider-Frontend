...
const BusinessLoanFeatures = () => {
    const features = [
        {
            icon: <FiUserCheck />,
            title: "Reach Active Borrowers",
            description: "We help to connect lenders with entrepreneurs who are actively looking for funding. The leads are designed for organizations, working capital, term loans, equipment financing, or growth funds, allowing you to focus on actual demand rather than cold outreach."
        },
        {
            icon: <FiZap />,
            title: "Controlled Cost Per Lead",
            description: "Buy business loan leads based on volume and delivery preferences. This model helps you control acquisition expenses while providing consistent lead flow without long-term contracts or underutilized inventory."
        },
        {
            icon: <FiDollarSign />,
            title: "Scalable Lead Delivery",
            description: "As your sales capability varies, adjust your lead volume accordingly. Whether you require a stable business loan lead for a daily supply or a bigger volume during peak demand, our system ensures timely delivery."
        },
        {
            icon: <FiDatabase />,
            title: "Verified Leads Data",
            description: "Before delivery, each lead undergoes basic validation tests that include contact information, business information, and funding purpose. This reduces incorrect data and boosts contact rates for brokers and lenders."
        }
    ];
            ...
            <div className="container-custom relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
                    ...
                    <h2 className="text-fluid-3xl lg:text-fluid-4xl font-extrabold text-slate-900 leading-tight">
                        Targeted <span className="text-primary">Business Loan Lead</span> Solutions
