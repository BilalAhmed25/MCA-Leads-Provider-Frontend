                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="flex flex-col items-start text-left">
                        ...
                        {paragraphs.map((p, index) => (
                            <p
                                key={index}
                                className={`text-fluid-base text-slate-700 leading-relaxed ${index === paragraphs.length - 1 ? 'mb-10' : 'mb-6'
                                    }`}
                            >
                                {p}
                            </p>
                        ...
                        <Link to={buttonLink} className="inline-flex items-center justify-center px-8 py-3.5 bg-primary hover:bg-primary-hover text-white rounded-full font-bold text-fluid-sm transition-all duration-300 shadow-md">
                            {buttonText}
                        </Link>
                    </div>
                </div>
