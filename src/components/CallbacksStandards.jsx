...
const CallbacksStandards = () => {
    const leftCriteria = [
        "Business Operating for 6+ Months.",
        "Minimum Monthly Revenue of $15,000.",
        "Active Business Bank Account.",
        "No Recent Bankruptcies.",
        "Clear Intent for Business Funding.",
        "Valid Contact Information & Availability.",
        "Positive Industry Standing & Reputation.",
        "Demonstrated Need for Working Capital."
    ];
            ...
            <div className="container-custom relative z-10">
                ...
                <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-10 gap-6">
                    <div className="max-w-4xl text-left">
                        ...
                        <h2 className="text-fluid-3xl lg:text-fluid-4xl font-extrabold text-slate-900 leading-tight">
                            Call Back MCA Leads <span className="text-primary">Criteria for Quality Leads</span>
                        </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                    ...
                    <div className="lg:col-span-1 flex">
                        <div className="bg-linear-to-br from-primary via-[#5317d6] to-[#3a0bb5] rounded-[2.5rem] text-white p-8 sm:p-10 shadow-2xl relative overflow-hidden group hover:-translate-y-1 transition-all duration-350 flex flex-col justify-between w-full h-full">
                            ...
                            <div className="relative z-10 w-full">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="flex items-baseline mt-2">
                                        <span className="text-fluid-4xl lg:text-fluid-5xl font-black tracking-tight">$35.00</span>
...
export default CallbacksStandards;
