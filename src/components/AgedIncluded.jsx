    ...
    const items = [
        {
            ...
            description: "Give your sales team access to companies that have expressed interest in borrowing money in the past, which will increase the possibility that they will convert."
        },
        {
            icon: <FiSearch />,
            title: "In-Depth Lead Intelligence",
            description: "To assist you in effectively planning your outreach, each record contains behavioral data, financing history patterns, and contact decency."
        },
        {
            icon: <FiAward />,
            title: "Pre-Qualified Leads",
            description: "To help you get started right away, leads are categorized into priority categories according to activity, funding goal, and response potential."
        },
        {
            icon: <FiCheckSquare />,
            title: "Optimized Data Accuracy",
            description: "Use optional lead refresh add-ons to keep your data up to date so your pitch is successful."
        }
    ];
            ...
            <div className="container-custom relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
                    ...
                    <h2 className="text-fluid-3xl lg:text-fluid-5xl font-extrabold text-slate-900 leading-tight">
                        What Is Included In Our <span className="text-primary">Aged MCA Leads?</span>
                    </h2>
